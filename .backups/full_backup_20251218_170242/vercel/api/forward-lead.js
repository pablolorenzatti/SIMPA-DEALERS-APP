...
for (const razonesSocialesPath of razonesSocialesPaths) {
  try {
    if (fs.existsSync(razonesSocialesPath)) {
      ...
      console.log(`[forward-lead] ✅ razones-sociales.json cargado desde: ${razonesSocialesPath}`);
      break;
    }
  } catch (error) {
...
if (!razonesSocialesConfig) {
  try {
    ...
    console.log('[forward-lead] ✅ razones-sociales.json cargado con require');
  } catch (error) {
    try {
      razonesSocialesConfig = require('../src/config/razones-sociales.json');
      console.log('[forward-lead] ✅ razones-sociales.json cargado con require relativo');
    } catch (error2) {
      console.warn('[forward-lead] ⚠️ Usando fallback hardcodeado para razones-sociales.json');
      // Fallback hardcodeado con la configuración actual
      razonesSocialesConfig = {
        "SPORTADVENTURE": { "tokenEnv": "SPORTADVENTURE_TOKEN", "brands": [], "dealers": [] },
        "BAMP MOTORCYCLES SA": { "tokenEnv": "BAMP_MOTORCYCLES_SA_TOKEN", "brands": [], "dealers": [] },
        "I CASA": { "tokenEnv": "I_CASA_TOKEN", "brands": [], "dealers": [] },
        "RE VESPA MENDOZA SAS": { "tokenEnv": "RE_VESPA_MENDOZA_SAS_TOKEN", "brands": [], "dealers": [] },
        "ASIAN MOTION POINT S.A.": { "tokenEnv": "ASIAN_MOTION_POINT_SA_TOKEN", "brands": [], "dealers": [] },
        "BUENOS RUMBOS SA": { "tokenEnv": "BUENOS_RUMBOS_SA_TOKEN", "brands": [], "dealers": [] },
        "CLAUSELL RICARDO ARIEL": { "tokenEnv": "CLAUSELL_RICARDO_ARIEL_TOKEN", "brands": [], "dealers": [] },
        "LEMAMOTOR SA": { "tokenEnv": "LEMAMOTOR_SA_TOKEN", "brands": [], "dealers": [] },
        "OLIVERA ROBERTO FEDERICO": { "tokenEnv": "OLIVERA_ROBERTO_FEDERICO_TOKEN", "brands": [], "dealers": [] },
        "PRO ONE SA": { "tokenEnv": "PRO_ONE_SA_TOKEN", "brands": [], "dealers": [] },
        "QJ MENDOZA SAS": { "tokenEnv": "QJ_MENDOZA_SAS_TOKEN", "brands": [], "dealers": [] },
        "ROYAL MOTORS SA": { "tokenEnv": "ROYAL_MOTORS_SA_TOKEN", "brands": [], "dealers": [] },
        "URBAN MOBILITY SRL": { "tokenEnv": "URBAN_MOBILITY_SRL_TOKEN", "brands": [], "dealers": [] },
        "USADOS DE CALIDAD SRL": { "tokenEnv": "USADOS_DE_CALIDAD_SRL_TOKEN", "brands": [], "dealers": [] },
        "BUENAS RUTAS": { "tokenEnv": "BUENAS_RUTAS_TOKEN", "brands": [], "dealers": [] },
        "CORDASCO": { "tokenEnv": "CORDASCO_TOKEN", "brands": [], "dealers": [] },
        "ALTO OESTE": { "tokenEnv": "ALTO_OESTE_TOKEN", "brands": [], "dealers": [] },
        "MOTOLIFE SA": { "tokenEnv": "MOTOLIFE_SA_TOKEN", "brands": [], "dealers": [] },
        "NSM": { "tokenEnv": "NSM_TOKEN", "brands": [], "dealers": [] },
        "REYVEN": { "tokenEnv": "REYVEN_TOKEN", "brands": [], "dealers": [] },
        "SUR VALLEY SA": { "tokenEnv": "SUR_VALLEY_SA_TOKEN", "brands": [], "dealers": [] },
